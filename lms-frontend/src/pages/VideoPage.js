  ...
  return (
    <div className="video-page">
      ...
      content.data?<iframe
        ...
        frameBorder={0}
        className='video'
      ></iframe>:<div>No video data available</div>}
      <OptionsButton isEditing={isEditing} setIsEditing={setIsEditing} handleSave={handleSave} handleCancel={handleCancel} handleDelete={handleContentDelete}/>
    </div>
  );
}
